...
const Exchange = (props) => {
  ...
  const [selectedToToken, setSelectedToToken] = useState({
    address: "0xF302AaB56D748a2f53Bf9fB23ce1c575481FA712",
    decimals: 9,
    image: logo,
    label: "VICTORY",
    logoURI: logo,
  ...
  const initSwap = async () => {
    ...
    let exchangeType;
    if (selectedFromToken.name === "BNB") {
      exchangeType = "VICtoToken";
    } else if (selectedToToken.name === "BNB") {
      exchangeType = "tokenToVIC";
    } else {
            ...
            <Popup2 trigger={divPopup2} setTrigger={setButtonPopup2}>
              <div>
                <iframe
                  ...
                  src={
                    "https://hub.peachfolio.app/?address=0xF302AaB56D748a2f53Bf9fB23ce1c575481FA712&network=BSC&ticker=VICTORY"
                  }
