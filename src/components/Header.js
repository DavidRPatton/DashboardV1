    ...
    <div className="header ">
                ...
                <div className="nav-right d-flex flex-row align-items-center">
                  <div className="wallet-address-container">
                    ...
                    <div>
                      {balance ? (
                        <>
                          <div className="text-gray">Your VICTORY Balance</div>
      ...
      <div className="row mob-display ">
        <div className="mob-scroll-wrap">
          <TopSlider
            holdersPot={Number(contractData.holdersPot).toFixed(4)}
            ...
            distributedRewards={Number(contractData.distributedRewards).toFixed(
              2
            )}
            BUSD
